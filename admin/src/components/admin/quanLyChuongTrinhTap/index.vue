    ...
    <div class="card">
      ...
      <section class="filter-bar align-middle">
        ...
        <div class="filter-container">
          ...
          <button class="btn-new" @click="openModal(null, 'edit')">
            + New...
          </button>
        </div>
      </section>
        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              >
                <td class="row-index">
                  <h6>{{ (currentPage - 1) * limit + idx + 1 }}</h6>
                </td>
                <td class="row-name">
                  <h6>{{ prog.name }}</h6>
                </td>
                <td class="row-info">
                  ...
                  <p v-if="prog.isPaid">
                    Price: {{ formatNumber(prog.price) }}đ
                  </p>
                  <p v-else>Free</p>
                </td>
                <td class="row-actions">
                  <div class="btn-group">
                    <button
                      class="btn-view"
                      @click="openModal(prog._id, 'view')"
                    >
                      View
                    </button>
                    <button
                      class="btn-edit"
                      @click="openModal(prog._id, 'edit')"
                    >
                      Edit
                    </button>
                    <button class="btn-delete" @click="promptDelete(prog._id)">
                      Delete
                    </button>
                  </div>
                </td>
