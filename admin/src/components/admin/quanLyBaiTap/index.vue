        ...
        <div class="table-responsive">
          <table class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              >
                <td class="row-index">
                  <h6>{{ (currentPage - 1) * limit + index + 1 }}</h6>
                </td>
                ...
                <td class="row-actions">
                  <div class="btn-group">
                    <button class="btn-view" @click="viewExercise(ex._id)">
                      View
                    </button>
                    <button class="btn-edit" @click="editExercise(ex._id)">
                      Edit
                    </button>
                    <button class="btn-delete" @click="deleteExercise(ex._id)">
                      Delete
                    </button>
                  </div>
                </td>
...
async function fetchExercises() {
  ...
  try {
    ...
    if (selectedEquipment.value) params.equipment = selectedEquipment.value;
...
function createExercise() {
  openEditModal(null, "edit");
}
function viewExercise(id) {
  openEditModal(id, "view");
}
