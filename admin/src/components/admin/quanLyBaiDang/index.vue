          ...
          <section class="card-body">
              <div class="table-responsive">
                  <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                        <tr v-for="(art, index) in articles" :key="art._id" class="data-row">
                          ...
                          <td class="row-actions">
                            <div class="btn-group">
                              <button class="btn-view" @click="viewArticle(art._id)">View</button>
                              <button class="btn-edit" @click="editArticle(art._id)">Edit</button>
                              <button class="btn-delete" @click="deleteArticle(art._id)">Delete</button>
                            </div>
                          </td>
                        </tr>
                      </tbody>
...
const currentPage = ref(1); const totalPages = ref(1); const pageSize = ref(10);
...
function createArticle()  { openModal(null, 'edit');  }
